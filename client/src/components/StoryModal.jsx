...
const StoryModal = ({setShowModel, fetchStories}) => {
    ...
    const bgColors = ["#4f46e5", "#7c3eee", "#db2777", "#e11d48", "#ca8a04", "#0d9488"]
  ...
  return (
    <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur-2xl
    text-white flex items-center justify-center p-4'>
        <div className='w-full max-w-md'>
            <div className='text-center md-4 flex items-center justify-between'>
            ...
            <div className='flex gap-2 mt-4'>
                <button onClick={()=> {setMode('text'); setMedia(null); setPreviewUrl(null)}} className={`flex-1 flex items-center justify-center gap-2 p-2 rounded
            ...
            rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition cursor-pointer'>
